...
*Disclaimer: all content in the example CV was generated by Claude and may contain factual errors.*
...
The sections excluded from the resume are those wrapped in `\ifcv ... \fi` braces:
